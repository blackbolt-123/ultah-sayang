  ...
  sections: [
    {
      type: "greeting",
      title: "Hi",
      subtitle: "Ada sesuatu yang pengen aku sampein hari ini...",
    },
    {
      type: "countdown",
      from: 3,
    ...
    },
    {
      ...
      lines: [
        ...
        "Tentang seseorang yang aku sayang banget.",
        "Dia itu baik. Bukan baik yang pura-pura.",
        "Tapi baik yang <strong>tulus</strong>.",
        "Selalu ada. Selalu ngusahain.",
        "Dan aku <strong>beruntung banget</strong>...",
        "Orang itu adalah <span>kamu</span> 🩷",
      ],
      bigLetters: "♡",
    },
    {
      type: "quote",
      text: "Kamu ngajarin aku artinya cinta yang tulus — bukan yang neko-neko, tapi yang selalu ada dan selalu ngusahain. Makasih udah prioritasin aku.",
    ...
    {
      type: "closing",
      text: "Selamat ulang tahun. Semoga kamu tahu betapa berharganya kamu — buat orang-orang di sekitarmu, dan buat aku.",
