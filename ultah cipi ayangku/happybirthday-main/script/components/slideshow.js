  ...
  window.Components.slideshow = {
    ...
    _showPhoto(div, index, animate = true, direction = "next") {
      ...
      if (animate) {
        ...
        const leaveTo = direction === "next" ? -40 : 40;

        // Kill any existing tweens on img and caption
        gsap.killTweensOf(div._img);
        gsap.killTweensOf(div._caption);
        gsap.killTweensOf(div._heartTop);

        // Animate image: slide in + scale + blur clear
        ...
        // Floating heart effect on each transition
